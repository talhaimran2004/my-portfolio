...
(function () {
  ...
  let listItem = document.querySelectorAll('.lit')
  ...
  if (selectHeader) {
    ...
    const headerFixed = () => {
      if ((headerOffset - window.scrollY) <= 0) {
        ...
        list.classList.remove('flexing')
        list.classList.add('blocking')
        list.classList.add('margers')
        for (const lit of listItem) {
          lit.classList.remove('padders')
        }

      } else {
        selectHeader.classList.remove('fixed-top')
        nextElement.classList.remove('scrolled-offset')
        list.classList.add('flexing')
        list.classList.remove('blocking')
        list.classList.remove('margers')

        for (const lit of listItem) {
          lit.classList.add('padders');
        }
